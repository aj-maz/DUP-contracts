 ...
 *
 */
abstract contract GovernorTimelockControlCore is
    IGovernorTimelock,
    GovernorCore
{
    TimelockControllerCore internal _timelock;
     ...
     */
    function queue(bytes[] memory calldatas, bytes32 descriptionHash)
        public
        virtual
        override
        returns (uint256)
    {
        ...
        _timelock.scheduleBatch(calldatas, 0, descriptionHash, delay);
    ...
    function _execute(
        ...
        _timelock.executeBatch{value: msg.value}(calldatas, 0, descriptionHash);
    }
    ...
    function _cancel(bytes[] memory calldatas, bytes32 descriptionHash)
        ...
        returns (uint256)
    {
        uint256 proposalId = super._cancel(calldatas, descriptionHash);
     ...
     */
    function updateTimelock(TimelockControllerCore newTimelock)
        external
        virtual
        onlyGovernance
    {
    ...
    function _updateTimelock(TimelockControllerCore newTimelock) internal {
